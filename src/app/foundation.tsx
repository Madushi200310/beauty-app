...
export default function FoundationScreen() {
  ...
  useEffect(() => {
    ...
    setColors(rec.foundation.colors);
    setLoading(false);
  }, [params.sliderValue]);
      ...
      <View style={styles.pageBorder}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.pageTitle}>Foundation Shades</Text>
            <Text style={styles.pageSubtitle}>Find your perfect match</Text>
          </View>
        </View>
        ...
        <View style={styles.tipBox}>
          <Text style={styles.tipText}>💡 These foundation shades are perfectly matched to your skin tone for a seamless, natural look.</Text>
        </View>
