...
export default function NailPolishScreen() {
  ...
  useEffect(() => {
    ...
    setColors(rec.nailPolish.colors);
    setLoading(false);
  }, [params.sliderValue]);
      ...
      <View style={styles.pageBorder}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.pageTitle}>Nail Polish Colors</Text>
            <Text style={styles.pageSubtitle}>Perfect shades for your nails</Text>
          </View>
        </View>
        ...
        <View style={styles.tipBox}>
          <Text style={styles.tipText}>💡 These nail polish colors will complement your skin tone and add a touch of elegance to your look.</Text>
        </View>
