...
const ColorGrid = ({ colors }: { colors: { name: string; color: string }[] }) => {
  // Split colors into rows of 3 for better visibility
  const rows = [];
      ...
      <View style={styles.pageBorder}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.pageTitle}>Clothing Colors</Text>
            <Text style={styles.pageSubtitle}>Perfect shades for your skin tone</Text>
          </View>
        </View>
        ...
        <View style={styles.tipBox}>
          <Text style={styles.tipText}>💡 These colors complement your skin tone perfectly. Mix and match for stunning outfits!</Text>
        </View>
