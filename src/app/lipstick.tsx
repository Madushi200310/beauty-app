      ...
      <View style={styles.pageBorder}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.pageTitle}>Lipstick Shades</Text>
            <Text style={styles.pageSubtitle}>Find your perfect pout</Text>
          </View>
        </View>
        ...
        <View style={styles.tipBox}>
          <Text style={styles.tipText}>💡 These lipstick shades are carefully selected to complement your skin tone and enhance your natural beauty.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  colorSwatch: {
    width: 70,
    height: 70,
    borderRadius: 35, // Circle for lipstick
    borderWidth: 1,
