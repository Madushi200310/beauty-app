...
export default function ContactLensScreen() {
  ...
  useEffect(() => {
    ...
    setColors(rec.contactLens.colors);
    setLoading(false);
  }, [params.sliderValue]);
      ...
      <View style={styles.pageBorder}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.pageTitle}>Contact Lens Colors</Text>
        ...
        <View style={styles.tipBox}>
          <Text style={styles.tipText}>💡 These contact lens colors will beautifully complement your skin tone and make your eyes stand out.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  colorSwatch: {
    width: 70,
    height: 70,
    borderRadius: 35, // Circle for contact lenses
    borderWidth: 1,
